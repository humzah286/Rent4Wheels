...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=747415296ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=cars">`test001`.`cars`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=checkout">`test001`.`checkout`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=categories">`test001`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=password_resets">`test001`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=contact">`test001`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=users">`test001`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test001&table=Cars">`test001`.`Cars`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=classicmodels&table=employees">`classicmodels`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=classicmodels&table=customers">`classicmodels`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mine&table=info">`mine`.`info`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="55323977722e647c355061222227675c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test001" targettable="contact">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `contact`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `contact`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="cars">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cars`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="cars">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cars` WHERE &#039;Popular cars&#039; = 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="cars">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cars` WHERE `Popular cars` = 1 limit 3;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="categories">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `categories` WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="cars">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cars` WHERE category = &#039;Sedan&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="password_resets">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cars`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="checkout">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `checkout`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test001" targettable="cars">
                            <div class="action_content">
